	...
	<div class="container_16">
		<div class="grid_16" id="whiteBox">
			<div class="grid_8 push_3">
				<h1 class="push_2" style="padding: 10px 00px">Prodotti Nel
					Carrello</h1>
				...
				%>
				<h3 class="push_2">Prodotti nel Carrello:</h3>


				<%
					out.println("<br/>Totale Carrello &euro; " + cart.getTotalPriceOfCart());
